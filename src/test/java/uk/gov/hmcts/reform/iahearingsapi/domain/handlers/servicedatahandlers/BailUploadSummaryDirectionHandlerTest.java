...
class BailUploadSummaryDirectionHandlerTest {
    ...
    private BailUploadSummaryDirectionHandler bailUploadSummaryDirectionHandler;

    @BeforeEach
    public void setUp() {

        bailUploadSummaryDirectionHandler =
            new BailUploadSummaryDirectionHandler(coreCaseDataService);
    ...
    void should_have_early_dispatch_priority() {
        Assertions.assertEquals(DispatchPriority.EARLY, bailUploadSummaryDirectionHandler.getDispatchPriority());
    }

    @Test
    void should_handle_only_if_service_data_qualifies() {
        Assertions.assertTrue(bailUploadSummaryDirectionHandler.canHandle(serviceData));
    }
    ...
    void should_not_handle_if_hearing_type_unqualified() {
        ...
        Assertions.assertFalse(bailUploadSummaryDirectionHandler.canHandle(serviceData));
    }
    ...
    void should_trigger_case_listing() {
        ...
        bailUploadSummaryDirectionHandler.handle(serviceData);
