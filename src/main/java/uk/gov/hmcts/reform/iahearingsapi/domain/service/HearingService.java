...
public class HearingService {
    ...
    public HearingGetResponse getHearingResponse(String hearingId) throws HmcException {
    ...
    public ResponseEntity updatePartiesNotifiedResponse(String hearingId,
        ...
        try {
            ...
            return hmcHearingApi.updatePartiesNotifiedRequest(
                serviceUserToken,
                serviceAuthToken,
                payload,
                hearingId,
    ...
    public UnNotifiedHearingResponse getUnNotifiedHearingResponses(String hmctsServiceCode,
        ...
        try {
            ...
            return hmcHearingApi.getUnNotifiedHearingRequest(
                serviceUserToken,
                serviceAuthToken,
                hmctsServiceCode,
    ...
    public HearingsResponse getHearings(Long caseId, String status) {
        log.debug("Requesting Hearings for case: {}", caseId);
        try {
            String serviceUserToken = idamService.getServiceUserToken();
            String serviceAuthToken = serviceAuthTokenGenerator.generate();

            return hmcHearingApi.getHearings(
                serviceUserToken,
                serviceAuthToken,
                caseId,
                status);
